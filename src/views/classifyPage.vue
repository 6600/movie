<template>
    <div class="contain home">
        ...
        <transition name="el-fade-in-linear">
            <div class="searchIndex" v-if="index == 0">
                <el-row :gutter="10">
    ...
    methods: {
        ...
        moveLeft() {
            ...
            if (this.index == 1) {
                if (this.kd == 11 + this.typeList.category.length ||
                    ...
                    this.c.classList.remove("accs");
                    this.kd--;
                    if (this.kd >= 11 + this.typeList.category.length && this.kd < 11 + this.typeList.category.length + this.typeList.type.length) {
                    ...
                    if (this.kd >= 11 + this.typeList.category.length + this.typeList.type.length && this.kd < 11 + this.typeList.category.length + this.typeList.type.length
                    ...
                    if (this.kd >= 11 + this.typeList.category.length + this.typeList.type.length + this.typeList.region.length &&
                        this.kd < 11 + this.typeList.category.length + this.typeList.type.length + this.typeList.region.length + this.typeList.year.length) {
                        let el2 = document.getElementById(this.kd);
        ...
        changeIndex(val) {
            ...
            switch (d) {
                ...
                case 2: this.$router.push({ path: '/myPage' }); break;
                case 3: this.$router.push({ path: '/' }); break;
                // case 4: this.getzj(); break;
                case 4: this.$router.push({ path: '/albumPage' }); break;
