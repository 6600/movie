        ...
        <!-- <div class="tnr" @click="gosearch" id="1">
          <el-input placeholder="搜索" prefix-icon="el-icon-search" readonly>
                    ...
                    <div class="tnl" id="tnl">
                        ...
                        <span :class="{ active: index == 9 }" @click="changeIndex(9)" id="10">纪录片</span>
                    </div>
                </div>
            </el-col>
        </el-row>
        ...
        <el-row :gutter="10">
            <el-col :xs="22" :sm="22" :md="22" :lg="22" :xl="22" :offset="1">
                <transition name="el-fade-in-linear">
                    <div class="guoman zhuanji" v-if="index == 4">
                        <div class="zjtop">
                            <div class="topb" style="height:40vh" @click="goAlbum(item)" :id="11 + index"
                                v-for="(item, index) in albumList.fsList" :key="item.albumId">
                                <el-image v-if="item.albumCover != ''" :src="item.albumCover" fit="cover">
                        ...
                        <div class="nmovieList">
                            <div class="nmovie nmovie2" v-for="(item, index) in albumList.scList" @click="goAlbum(item)"
                                style="margin: 10px 0 ;height:30vh" :id="11 + albumList.fsList.length + index">
                                <el-image v-if="item.albumCover != ''" :src="item.albumCover" fit="cover">
                                    <div slot="placeholder" class="image-slot">
                                        <el-image :src="require('../assets/his.png')"></el-image>
                                    </div>
            ...
            <el-col :xs="22" :sm="22" :md="22" :lg="22" :xl="22" :offset="1">
                <transition name="el-fade-in-linear">
                    <div class="guoman" v-if="index == 5">
                        <!-- 列表 -->
                        <div class="tvtop">
                            <div class="tvtopbox" @click="goDetail(item)" v-for="(item, index) in dataList.frList"
                                :id="11 + index">
                                <el-image v-if="item.videoCove != ''" :src="item.videoCove" fit="cover">
                                    <div slot="placeholder" class="image-slot">
                                        <el-image :src="require('../assets/his.png')"></el-image>
                                    </div>
                                    <div slot="error" class="image-slot">
                        ...
                        <div class="typeList">
                            <p v-for="(item, index) in dataList.videoTypeList" @click="goAll('电视剧', item.typeId)"
                                :id="11 + dataList.frList.length + dataList.seList.length + index">{{ item.typeName }}
                            </p>
                        </div>
                        <div class="htpt">
    ...
    methods: {
        ...
        changeIndex(val) {
            ...
            switch (d) {
                ...
                case 2: Cookies.remove('kd');Cookies.remove('index');this.$router.push({ path: '/myPage' }); break;
